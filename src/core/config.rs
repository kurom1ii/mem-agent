...
pub const MODEL_DIR: &str = "plugins/opencode/models/embeddinggemma-300m-ONNX";
pub const TOKENIZER_PATH: &str = "plugins/opencode/models/embeddinggemma-300m-ONNX/tokenizer.json";
